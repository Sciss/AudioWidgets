...
AudioWidgets currently compiles against Scala 2.9.0 and requires Java 1.6. The repository contains a project file for Intellij IDEA 10 CE, and project files for sbt. Targets for sbt:
